...
const int frameNumber = 79;								//相机标定时需要采用的图像帧数
...
0 0  1
*/
Mat cameraMatrixL = (Mat_<double>(3, 3) << 354.462916, 0.000000, 318.796455, 0.000000, 355.052744, 
	183.938033, 0.000000, 0.000000, 1.000000);
Mat distCoeffL = (Mat_<double>(5, 1) << -0.180908, 0.029552, 0.000223, 0.000865, 0.000000
);
/*
事先标定好的右相机的内参矩阵
fx 0 cx
...
0 0  1
*/
Mat cameraMatrixR = (Mat_<double>(3, 3) << 345.178940, 0.000000, 337.897093, 0.000000, 344.821398, 203.442906,
 0.000000, 0.000000, 1.000000);
Mat distCoeffR = (Mat_<double>(5, 1) << -0.169650, 0.025820, -0.001486, 0.001162, 0.000000);
...
int main(int argc, char* argv[])
{
	...
	*/
	double rms = stereoCalibrate(objRealPoint, imagePointL, imagePointR,
		...
		TermCriteria(TermCriteria::COUNT + TermCriteria::EPS, 100, 1e-5),CALIB_USE_INTRINSIC_GUESS);
	...
	*/
	...
	cout <<"valid R "<< validROIR.size() << endl;
	cout << "valid L "<< validROIL.size() << endl;
	/*
